...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSDictionary* parameters = @{@"term":@"the",@"entity":@"movie",@"country":@"us",@"media":@"movie",@"attribute":@"movieTerm"};

    [[[SMQuickObjectMapper objectManagerWithBaseurl:BASEURL] rac_getPath:SEARCH_PATH parameters:parameters]
     ...
     progress:^(NSNumber *progress) {
         NSLog(@"progress: %.0f",progress.floatValue*100.0);
     }];
